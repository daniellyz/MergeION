...
#'
#' The function creates a folder "MSFinder" where .mat files are stored. These files can be imported to MSFinder software for structure elucidation. The files are named by IDs in user-defined metadata and contain at least MS2 scan. MS1 scan is added if available.
#'

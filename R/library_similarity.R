...
#' @param method Character. Method to compare the similarity between query spectrum and library spectra. "Simple": counting number of fragment matches. "Cosine": cosine similarity score from OrgMassSpecR package.
...
library_similarity<-function(library, query_spectrum=NULL , method = c("Simple", "Cosine"),
